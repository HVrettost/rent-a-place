...
UPDATE UNITS SET SEARCH_TOKENS = TO_TSVECTOR('san fransisco bay area majesty') WHERE UNIT_ID = 'b5d46ba0-b0e0-4f0e-a399-e796d3569d3a';
UPDATE UNITS SET SEARCH_TOKENS = TO_TSVECTOR('san fransisco cupertino lovers') WHERE UNIT_ID = 'b5d46ba0-b0e0-4f0e-a399-e796c3969d3a';